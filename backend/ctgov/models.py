...
class SearchStudies(models.Model):
    ...
    brief_title = models.TextField(blank=True, null=True)
    official_title = models.TextField(blank=True, null=True)
    nct_id = models.TextField(primary_key=True)
...
class Endpoints(models.Model):
    ...
    study_phase = models.CharField(max_length=255)
    arm_number = models.CharField(max_length=255)
    ...
    p_value = models.DecimalField(max_digits=65535, decimal_places=65535)
    p_value_description = models.CharField(max_length=255)
