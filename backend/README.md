...
1. Run the search_studies.sql script with the command: `psql -d aact -f database/scripts/search_studies.sql`
1. Connect to the aact database `psql -d aact`
1. Use the command `\dv` to list the views and verify that search_studies appears in the list of views.
